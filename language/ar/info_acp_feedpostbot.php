...
$lang = array_merge($lang, array(
	...
	'FPB_REQUIRE_URL_FOPEN'				=> 'يتطلب تنزيل الخلاصات توفر cURL أو تفعيل إعداد PHP المسمى allow_url_fopen. لا يتوفر أي منهما على هذا الخادم.',
	'FPB_SOURCE'						=> 'المصدر:',
	...
	'FPB_SETTINGS_INVALID'				=> 'اختر مستخدماً موجوداً ومنتدى يقبل المواضيع أو عطّل الخلاصة. يجب أن تكون المهلة من 1 إلى 60 ثانية، وحد النص من 0 إلى 1000000، والفاصل التلقائي من 0 إلى 31536000 ثانية.',
	'FPB_PROCESSING_FAILED'			=> 'تعذرت معالجة هذه الخلاصة. تحقق من الوجهة وحاول مجدداً.',
	'FPB_HTTP_UNSAFE'				=> 'يشير رابط الخلاصة إلى وجهة غير آمنة أو غير مدعومة.',
	'FPB_HTTP_FAILED'				=> 'تعذر تنزيل الخلاصة ضمن حدود الطلب والحجم.',
	'FPB_HTTP_TIMEOUT'				=> 'انتهت مهلة طلب الخلاصة.',
	'FPB_SAVE_CONFLICT'				=> 'تغيرت الخلاصات أو تجري معالجتها. أعد تحميل الصفحة وحاول الحفظ مرة أخرى.',
	'FPB_LOCK_ACTIVE'				=> 'قد تكون معالجة الخلاصات ما زالت جارية. تتم استعادة الأقفال المتروكة تلقائياً بعد ساعة.',
));
